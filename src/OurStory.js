    ...
    return (
      <div className="OurStory">
        <h1>Dr. Ashie, Founder & CEO</h1>
				...
				<p>"Why don't you teach college students at an University as a Professor?" My answer: Because it is far more challenging to explain “the central dogma” or “quantum mechanics” or “metabolomics” or “calculus” to a 5 year old at the dinner table.............And I'm up to that challenge.</p>
				...
				<p>I am putting together these tried, tested and tasted "yummilicious" experimental experiences in bite sized (pun intended) culinary programs for kids ages 5-10 to Enjoy!</p>
				<p></p>
				
				<section>
				<h2>BIO</h2>
				<p>Dr. Ashie Bhandiwad holds a PhD in Engineering from Dartmouth College. In her previous life Ashie worked at UC Berkeley trying to save the world - well almost: she worked at the Energy Biosciences Institute, UCB campus to produce renewable energy.</p>
