      ...
      <div className="OurStory">
				...
				<div className="OurStory__container">
					<section>
						...
						<p>Ashie Bhandiwad holds a PhD in Engineering from Dartmouth College. In her previous life, Ashie worked at UC Berkeley in the Energy Biosciences Institute working to produce renewable energy.</p>
						<p>Ashie lives with her husband and daughter in San Ramon and never misses going to the Saturday Farmer's market.</p>
					</section>
				</div>
      </div>
    );
