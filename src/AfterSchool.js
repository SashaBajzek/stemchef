				...
				<div className="AfterSchool__container">
					...
					<div className="AfterSchool__content">
						<section className="AfterSchool__section">
							...
							<section className="AfterSchool__class AfterSchool__class-youth">
								...
								<a className="AfterSchool__cta" href ="https://apm.activecommunities.com/danvilleca/Activity_Search/new-scientific-cooking-for-kids-6-11yr/8671">Register</a>
							</section>
							<section className="AfterSchool__class AfterSchool__class-youth">
								...
								<a className="AfterSchool__cta" href ="https://econnect.sanramon.ca.gov/econnect/Activities/ActivitiesCourseDetails.asp?UseLink=true&cid=120608">Register</a>
							</section>
							<section className="AfterSchool__class AfterSchool__class-youth">
								...
								<a className="AfterSchool__cta" href ="https://econnect.sanramon.ca.gov/econnect/Activities/ActivitiesCourseDetails.asp?UseLink=true&cid=120609">Register</a>
							</section>
						</section>
						<section className="AfterSchool__section">
							<h3 className="AfterSchool__title">Teens <span className="AfterSchool__age">(Ages 11-15)</span></h3>
							<section className="AfterSchool__class AfterSchool__class-teen">
								...
								<a className="AfterSchool__cta" href ="https://apm.activecommunities.com/danvilleca/Activity_Search/scientific-cooking/8583">Register</a>
							</section>
							<section className="AfterSchool__class AfterSchool__class-teen">
								...
								<a className="AfterSchool__cta" href ="https://apm.activecommunities.com/danvilleca/Activity_Search/scientific-cooking/8584">Register</a>
							</section>
						</section>
					</div>
				</div>
