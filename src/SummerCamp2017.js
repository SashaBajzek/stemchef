...
class SummerCamp2017 extends Component {
  render() {
    return (
      <div className="SummerCamp2017">
        <h1>Summer Camp 2017</h1>
				<section>
					<div className="SummerCamp2017__image SummerCamp2017__camp-image"></div>
				...
				<section>
					...
					<div className="SummerCamp2017__image SummerCamp2017__week-1-image"></div>
				...
				<section>
					...
					<div className="SummerCamp2017__image SummerCamp2017__week-2-image"></div>
				...
				<section>
					...
					<div className="SummerCamp2017__image SummerCamp2017__week-4-image"></div>
				...
				<section>
					...
					<h3>Price</h3>
					<p>Regular until June 12th 2017: $225/week</p>
					<p>Last minute after June 12th 2017: $250/week</p>
